  ...
  template: `
    @if (routerLink) {
      <a
        ...
        class="inline-flex rounded-lg p-2 transition-colors"
        [class]="toneClass"
      >
        @if (icon === 'edit') {
...
export class IconButtonComponent {
  ...
  get toneClass(): string {
    if (this.tone === 'danger') {
      return 'text-red-400 hover:bg-red-950/50 hover:text-red-300';
    }
    return 'text-indigo-400 hover:bg-slate-800 hover:text-indigo-300';
  }
}
